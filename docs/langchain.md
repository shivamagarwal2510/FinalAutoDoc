...
API Reference:WebBaseLoader | StrOutputParser | RunnablePassthrough | OpenAIEmbeddings | RecursiveCharacterTextSplitter
...
API Reference:create_retrieval_chain | create_stuff_documents_chain | ChatPromptTemplate
